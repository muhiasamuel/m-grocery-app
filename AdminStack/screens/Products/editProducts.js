 ...
 handleSubmit = async() => {
   ...
   this.setState({submitting: true})
    ...
    const productDiscount =  this.state.discount     
        await Firebase.firestore().collection("Products").doc(this.state.docId).update({
          ...
          createdAt: Date.now()
            ...
            if(this.state.photos !==null){
                this.uploadImage(this.state.docId)
              }else{
                alert('data updated');
  ...
  return(
    <SafeAreaView style={styles.container}>
       <View style={styles.CheckBox}> 
          ...
          placeholder='select Store to Update to'
          arrowColor='#FFD740'
          arrowSize={15}
      ...
      <View style={styles.CheckBox}>
        <PickerCheckBox
          ...
          placeholder='Select Product Category to Update to'
          arrowColor='#FFD740'
          arrowSize={15}
 ...
 renderCatImage(){
  ...
  return(
    <>
      ...
      <TouchableOpacity
           onPress={() =>navigation.navigate('ImageBrowser2')}
        >
